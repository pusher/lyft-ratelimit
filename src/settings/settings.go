...
type Settings struct {
	...
	RedisPoolPipelineWindowDuration          time.Duration `envconfig:"REDIS_POOL_PIPELINE_WINDOW_DURATION" default:"5ms"`
	RedisPoolPipelineWindowLimit             int           `envconfig:"REDIS_POOL_PIPELINE_WINDOW_LIMIT" default:"10"`
	...
	RedisPerSecondPoolPipelineWindowDuration time.Duration `envconfig:"REDIS_PERSECOND_POOL_PIPELINE_WINDOW_DURATION" default:"5ms"`
	RedisPerSecondPoolPipelineWindowLimit    int           `envconfig:"REDIS_PERSECOND_POOL_PIPELINE_WINDOW_LIMIT" default:"10"`
